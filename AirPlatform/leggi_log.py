...
print("Premi ")
print("1 Per grafico temperatura")
print("2 Per grafico umidita'")
print("3 Per grafico CO ")
print("4 Per grafico NH3: ")
print("5 Per grafico NO2:")
print("6 Per grafico CO2:")
print("7 Per grafico PM10:")
print("8 Per grafico PM25:")
print("9 Per grafico LAT:")
print("10 Per grafico LONG :")
print("11 Per grafico Tensione CO ")
print("12 Per grafico Tensione  NH3: ")
print("13 Per grafico Tensione NO2:")
print("14 Per grafico Tensione CO2:")

valore = raw_input("Inserisci numero sensore:")
numero_sensore = valore

print("Premi per selezionare")
print("1 Data attuale")
print("2 Inserire Data iniziale e Data finale grafico")

valore = raw_input("Inserisci valore:")
if valore == "1":
...
if valore == "2":
    ...
    data1 = raw_input("Inserisci data iniziale:")
    data2 = raw_input("Inserisci data finale:")
    ...
    if len(appo_stringa) > 1:
        if appo_stringa[1] == "*":
            ...
            if (giorno >= data1) & (giorno <= data2):
                ...
                # print ("Humidity " + str(umidita))
                # posizione=appo_stringa.find(" ")

                # if (posizione!=-1):
                #    data=appo_stringa[2:posizione-1]
                #    print(data)

                # valore=raw_input("Prem invio per procedere:")

                # ora_time_stampa=datetime.time(int(ora[0:1]),int(ora[3:4]),int(ora[6:7]))
